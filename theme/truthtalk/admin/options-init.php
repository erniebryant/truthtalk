...
if (!class_exists('truthtalk__Redux_Framework_config')) {

    class truthtalk__Redux_Framework_config {
...
//                        )
        ...
        public function setArguments() {
            ...
            $this->args = array(
                'opt_name' => 'truthtalk_option',
                'page_slug' => 'truthtalk_options',
                'page_title' => 'TruthTalk Options',
                'update_notice' => true,
...
// SOCIAL ICONS -> Setup custom links in the footer for quick links in your panel footer icons.
    ...
    global $reduxConfig;
    $reduxConfig = new truthtalk__Redux_Framework_config();
}

/**
  Custom function for the callback referenced above
 */
if (!function_exists('truthtalk__my_custom_field')):
    function truthtalk__my_custom_field($field, $value) {
        print_r($field);
        echo '<br/>';
        print_r($value);
    }
 ...
 * */
if (!function_exists('truthtalk__validate_callback_function')):
    function truthtalk__validate_callback_function($field, $value, $existing_value) {
        $error = false;
        $value = 'just testing';
